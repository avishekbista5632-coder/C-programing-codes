...
// Function to print the final solution, i.e., the shortest distances from the source vertex
...
void dijkstra(int graph[V][V], int src) {
    ...
    for (int count = 0; count < V - 1; count++) {
        ...
        for (int v = 0; v < V; v++) {
            ...
            // u to v, and the total weight of path from src to v through u is less
